...
class MockedCinemaRepository: CinemaRepositoring {
    ...
    func fetchPromotions() -> Single<[Promotion]> {
        print("fetch")
        return Single.just([
            Promotion(lat: 50.086537, lng: 14.411172, thumbnailId: "promotions/thumbnail_spiderslav", movie: spiderMan),
            Promotion(lat: 50.0943222, lng: 14.4417161, thumbnailId: "promotions/casino_royale_danube", movie: casinoRoyale)
        ])
    }
}
